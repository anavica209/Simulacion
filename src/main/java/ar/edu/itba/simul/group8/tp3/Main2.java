...
public class Main2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        OptionSpec<Long> timeOpt = parser.accepts("time").withRequiredArg().ofType(Long.class).defaultsTo(2000L);
...
//            
//            }
            tcs += brownianoImpl.getTiempoImpacto();
...
//        averages += tcs / brownTime;
        System.out.println(i);
        }
        
//        System.out.println("--" + averages / 10);
        writer.close();
    }
